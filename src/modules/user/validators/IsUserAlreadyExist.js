...
var IsUserAlreadyExistConstraint = /** @class */ (function () {
    function IsUserAlreadyExistConstraint(userService) {
        this.userService = userService;
    }
    IsUserAlreadyExistConstraint.prototype.validate = function (userName, args) {
    ...
    return IsUserAlreadyExistConstraint;
}());
